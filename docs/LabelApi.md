...
------------- | ------------- | -------------
[**list_attahced_labels_of_chart**](LabelApi.md#list_attahced_labels_of_chart) | **GET** /chartrepo/{repo}/charts/{name}/{version}/labels | Return the attahced labels of chart.
[**mark_label_to_chart**](LabelApi.md#mark_label_to_chart) | **POST** /chartrepo/{repo}/charts/{name}/{version}/labels | Mark label to chart.
[**remove_label_from_chart**](LabelApi.md#remove_label_from_chart) | **DELETE** /chartrepo/{repo}/charts/{name}/{version}/labels/{id} | Remove label from chart.
...
with harbor_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling LabelApi->list_attahced_labels_of_chart: %s\n" % e)
```
...
with harbor_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling LabelApi->mark_label_to_chart: %s\n" % e)
```
...
with harbor_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling LabelApi->remove_label_from_chart: %s\n" % e)
```
