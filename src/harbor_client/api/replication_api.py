...
class ReplicationApi(object):
    ...
    def create_replication_policy_with_http_info(self, policy, **kwargs):    # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}' to method create_replication_policy"
                )
            params[key] = val
        del params['kwargs']
    ...
    def delete_replication_policy_with_http_info(self, id, **kwargs):    # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}' to method delete_replication_policy"
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_replication_execution_with_http_info(self, id, **kwargs):    # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}' to method get_replication_execution"
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
    ...
    def get_replication_log_with_http_info(self, id, task_id, **kwargs):    # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}' to method get_replication_log"
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
    ...
    def get_replication_policy_with_http_info(self, id, **kwargs):    # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}' to method get_replication_policy"
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
    ...
    def list_replication_executions_with_http_info(self, **kwargs):    # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}' to method list_replication_executions"
                )
            params[key] = val
        del params['kwargs']
    ...
    def list_replication_policies_with_http_info(self, **kwargs):    # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}' to method list_replication_policies"
                )
            params[key] = val
        del params['kwargs']
    ...
    def list_replication_tasks_with_http_info(self, id, **kwargs):    # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}' to method list_replication_tasks"
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
    ...
    def start_replication_with_http_info(self, execution, **kwargs):    # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}' to method start_replication"
                )
            params[key] = val
        del params['kwargs']
        ...
        body_params = params.get('execution')
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
