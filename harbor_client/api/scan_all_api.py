    ...
    def __init__(self, api_client=None):
        ...
        self.create_scan_all_schedule = _Endpoint(
            settings={
                ...
                'endpoint_path': '/system/scanAll/schedule',
                'operation_id': 'create_scan_all_schedule',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            callable=__create_scan_all_schedule
        )
        ...
        self.get_latest_scan_all_metrics = _Endpoint(
            settings={
                'response_type': (Stats,),
                'auth': [
                    'basic'
                ],
                'endpoint_path': '/scans/all/metrics',
                'operation_id': 'get_latest_scan_all_metrics',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_latest_scan_all_metrics
        )
        ...
        self.get_latest_scheduled_scan_all_metrics = _Endpoint(
            settings={
                'response_type': (Stats,),
                'auth': [
                    'basic'
                ],
                'endpoint_path': '/scans/schedule/metrics',
                'operation_id': 'get_latest_scheduled_scan_all_metrics',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_latest_scheduled_scan_all_metrics
        )
        ...
        self.get_scan_all_schedule = _Endpoint(
            settings={
                ...
                'endpoint_path': '/system/scanAll/schedule',
                'operation_id': 'get_scan_all_schedule',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_scan_all_schedule
        )
        ...
        self.update_scan_all_schedule = _Endpoint(
            settings={
                ...
                'endpoint_path': '/system/scanAll/schedule',
                'operation_id': 'update_scan_all_schedule',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__update_scan_all_schedule
        )
