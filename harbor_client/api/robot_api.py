...
class RobotApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_robot = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basic'
                ],
                'endpoint_path': '/robots/{robot_id}',
            ...
            api_client=api_client,
            callable=__delete_robot
        )

        def __get_robot_by_id(
            self,
            robot_id,
            **kwargs
        ):
        ...
        self.get_robot_by_id = _Endpoint(
            settings={
                'response_type': (Robot,),
                'auth': [
                    'basic'
        ...
        self.refresh_sec = _Endpoint(
            settings={
                'response_type': (RobotSec,),
                'auth': [
                    'basic'
                ],
                'endpoint_path': '/robots/{robot_id}',
                'operation_id': 'refresh_sec',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
