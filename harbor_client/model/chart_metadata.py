...
class ChartMetadata(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, version, engine, icon, api_version, app_version, *args, **kwargs):  # noqa: E501
        """ChartMetadata - a model defined in OpenAPI
