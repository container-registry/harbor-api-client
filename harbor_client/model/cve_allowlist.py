...
def lazy_import():
    ...
    globals()['CVEAllowlistItem'] = CVEAllowlistItem


class CVEAllowlist(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """CVEAllowlist - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            expires_at (int): the time for expiration of the allowlist, in the form of seconds since epoch.  This is an optional attribute, if it's not set the CVE allowlist does not expire.. [optional]  # noqa: E501
        """
